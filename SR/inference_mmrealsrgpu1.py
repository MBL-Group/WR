...
if __name__ == '__main__':
    ...
    parser.add_argument('-opt', type=str, default='experiments/finetune_MMRealSRGANModel_x4_version2/finetune_MMRealSRGAN_x4.yml')
    parser.add_argument('--model_path', type=str, default='./experiments/finetune_MMRealSRGANModel_x4_version2/models/net_g_latest.pth')
    parser.add_argument('--im_path', type=str, default='./datasets/N2-adults-50um')
    parser.add_argument('--res_path', type=str, default='results/N2-adults-50um-SRx5')
